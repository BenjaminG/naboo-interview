...
describe('formatDebugDate', () => {
  ...
  it('formats dates in various months correctly', () => {
    expect(formatDebugDate('2026-02-20T12:00:00.000Z')).toBe('20 févr. 2026');
    expect(formatDebugDate('2026-03-05T12:00:00.000Z')).toBe('5 mars 2026');
    expect(formatDebugDate('2026-06-01T12:00:00.000Z')).toBe('1 juin 2026');
    expect(formatDebugDate('2026-12-31T12:00:00.000Z')).toBe('31 déc. 2026');
  });
  ...
  it('handles ISO date strings', () => {
    ...
    expect(result).toBe('4 juil. 2026');
  });
});
